    ...
    public class ApplicationDbInitializer
    {
        public static async Task SeedRolesAndUsersAsync(IServiceProvider serviceProvider, ApplicationDbContext context)
        {
            ...
            if (!context.Websites.Any())
            {
                ...
                string code = @$"<div class=""content-wrapper"">
    <div class=""row"">
        <div class=""col-sm-12"">
            <div class=""home-tab"">
                ...
                var masteruiCode = new MasterUICodes
                {
                    PageName = "HomePage",
                    PageCode = code,
                    WebsiteId= websiteid,
                ...
                await context.MasterUICodes.AddAsync(masteruiCode);
            ...
            if (!context.DatabaseMasters.Any())
            {
                var databaseMasters = new DatabaseMaster
                {
                    ...
                    ConnectionString = "Server=mysql.gb.stackcp.com;Port=61219;Database=CRMDatabase-3133312126;User=CRMDatabase;Password=,qabufnfn_<s;",
                    IsDeleted = false,
                    WebsiteId=websiteid,
